...
import com.study.android.ex37_video2.R;
...
public class MainActivity extends AppCompatActivity
{
    ...
    public void recordVideo()
    {
        ...
        viedoUri = FileProvider.getUriForFile(MainActivity.this,
                getApplicationContext().getPackageName() + ".fileprovider",
                videoFilename);

        Intent intent = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
        intent.putExtra(MediaStore.EXTRA_OUTPUT, viedoUri);
    ...
    {
        videoView1.setVideoURI(viedoUri);
        videoView1.start();
    }
}

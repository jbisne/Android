package com.study.android.ex38_audio;
...
public class RecordActivity extends AppCompatActivity
{
    ...
    private static String RECOREDE_FILE;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        RECOREDE_FILE = file.getAbsolutePath();
    ...
    public void onBtn1Clicked(View v)
    {
        ...
        recorder.setOutputFile(RECOREDE_FILE);
    ...
    public void onBtn3Clicked(View v)
    {
        ...
        try
        {
            ...
            player.setDataSource(RECOREDE_FILE);
            player.prepare();
            player.start();
        }
        catch (Exception e)
